...
/**
 * Timer - Manages timed events with automatic expiration checking
 * Handles browser sleep/wake scenarios where timers may be delayed
 */
...
/**
 * ClockService - Provides current epoch time
 */
